...
export const screen4 = {
  ...
  cards: [
    ...
    },
    {
      ...
      body: { text: 'Breaking up long periods of sitting, for example with a short walk after eating, may support how the body handles blood sugar.', refs: [10] },
      image: '/images/habits/walk-after-meal.webp',
      alt: 'A person walking along a path after a meal',
    },
    {
      title: 'Look at the whole plate',
      body: { text: 'Including protein and fibre in meals is linked with a gentler rise in blood sugar after eating.', refs: [11, 12] },
    ...
    },
    {
      ...
      body: { text: 'Long-term stress can influence blood sugar and other key health measures over time.', refs: [13] },
...
export const screen5 = {
  ...
  measures: [
    { title: 'Blood sugar — HbA1c & blood glucose', body: { text: 'HbA1c reflects your average blood sugar over roughly the past three months.', refs: [14] } },
    { title: 'Blood fats — Cholesterol', body: { text: 'A lipid profile shows cholesterol and triglycerides together.' } },
    { title: 'Circulation — Blood pressure', body: { text: 'Blood pressure can be high without any obvious symptoms.', refs: [15] } },
...
export const screen6 = {
  ...
  signs: [
    { text: 'Gradual weight gain', refs: [17, 3], image: '/images/signs/clothes-jeans.webp', alt: 'Waistband of jeans fitting more tightly than before' },
    ...
    { text: 'Swelling around the feet or ankles', refs: [18], image: '/images/signs/ankles.webp', alt: 'Hands resting on bare feet and ankles at home' },
    { text: 'Knee joint pain', refs: [19], image: '/images/signs/knee.webp', alt: 'Someone sitting on a sofa, holding their knee' },
  ],
  otherHeading: 'Other changes people sometimes mention',
  other: [
    { text: 'Fatigue, low energy or reduced stamina', refs: [20], image: '/images/signs/tired.webp', alt: 'Someone pausing at a desk, tired during the day' },
    { text: 'Breathlessness during routine activities', refs: [21], image: '/images/signs/stairs.webp', alt: 'Someone partway up a flight of stairs' },
  ],
  closing: {
...
export const references: { n: number; text: string; url: string }[] = [
  { n: 1, text: 'Lloyd-Jones DM, et al. Life’s Essential 8: Updating and Enhancing the American Heart Association’s Construct of Cardiovascular Health: A Presidential Advisory From the American Heart Association. Circulation. 2022;146(5):e18-e43.', url: 'https://doi.org/10.1161/CIR.0000000000001078' },
  ...
  { n: 3, text: 'Ross R, et al. Waist circumference as a vital sign in clinical practice: a Consensus Statement from the IAS and ICCR Working Group on Visceral Obesity. Nat Rev Endocrinol. 2020;16(3):177-189.', url: 'https://doi.org/10.1038/s41574-019-0310-7' },
  { n: 4, text: 'Thomas EL, Frost G, Taylor-Robinson SD, Bell JD. Excess body fat in obese and normal-weight subjects. Nutr Res Rev. 2012;25(1):150-161.', url: 'https://doi.org/10.1017/S0954422412000054' },
  ...
  { n: 6, text: 'Mottillo S, et al. The metabolic syndrome and cardiovascular risk: a systematic review and meta-analysis. J Am Coll Cardiol. 2010;56(14):1113-1132.', url: 'https://doi.org/10.1016/j.jacc.2010.05.034' },
  { n: 7, text: 'Muzurović E, et al. Nonalcoholic Fatty Liver Disease and Cardiovascular Disease: a Review of Shared Cardiometabolic Risk Factors. Hypertension. 2022;79(7):1319-1326.', url: 'https://doi.org/10.1161/HYPERTENSIONAHA.122.17982' },
  ...
  { n: 10, text: 'Quan M, Xun P, Wu H, et al. Effects of interrupting prolonged sitting on postprandial glycemia and insulin responses: a network meta-analysis. J Sport Health Sci. 2021;10(4):419–429.', url: 'https://doi.org/10.1016/j.jshs.2020.12.006' },
  { n: 11, text: 'Wolever TMS, Zurbau A, Koecher K, Au-Yeung F. The Effect of Adding Protein to a Carbohydrate Meal on Postprandial Glucose and Insulin Responses: A Systematic Review and Meta-Analysis of Acute Controlled Feeding Trials. J Nutr. 2024;154(9):2640-2654.', url: 'https://doi.org/10.1016/j.tjnut.2024.07.011' },
  { n: 12, text: 'Zurbau A, et al. The effect of oat β-glucan on postprandial blood glucose and insulin responses: a systematic review and meta-analysis. Eur J Clin Nutr. 2021;75(11):1540-1554.', url: 'https://doi.org/10.1038/s41430-021-00875-9' },
  { n: 13, text: 'Bergmann N, Gyntelberg F, Faber J. The appraisal of chronic stress and the development of the metabolic syndrome: a systematic review of prospective cohort studies. Endocr Connect. 2014;3(2):R55–R80.', url: 'https://doi.org/10.1530/EC-14-0031' },
  { n: 14, text: 'American Diabetes Association Professional Practice Committee. 6. Glycemic Goals, Hypoglycemia, and Hyperglycemic Crises: Standards of Care in Diabetes—2026. Diabetes Care. 2026;49(Suppl 1):S132–S149.', url: 'https://doi.org/10.2337/dc26-S006' },
  { n: 15, text: 'World Health Organization. Hypertension. Fact sheet, updated 25 September 2025.', url: 'https://www.who.int/news-room/fact-sheets/detail/hypertension' },
  { n: 16, text: 'National Institute for Health and Care Excellence (NICE). NG246: Overweight and obesity management – identifying and assessing overweight, obesity and central adiposity.', url: 'https://www.nice.org.uk/guidance/ng246/chapter/Identifying-and-assessing-overweight-obesity-and-central-adiposity' },
  { n: 17, text: 'Jayedi A, et al. Adult weight gain and the risk of cardiovascular disease: a systematic review and dose-response meta-analysis of prospective cohort studies. Eur J Clin Nutr. 2020;74(9):1263-1275.', url: 'https://doi.org/10.1038/s41430-020-0610-y' },
  { n: 18, text: 'Burian EA, et al. The impact of obesity on chronic oedema/lymphoedema of the leg – an international multicenter cross-sectional study (LIMPRINT). Int J Obes (Lond). 2024;48(9):1238-1247.', url: 'https://doi.org/10.1038/s41366-024-01544-0' },
  { n: 19, text: 'Zheng H, Chen C. Body mass index and risk of knee osteoarthritis: systematic review and meta-analysis of prospective studies. BMJ Open. 2015;5(12):e007568.', url: 'https://doi.org/10.1136/bmjopen-2014-007568' },
  { n: 20, text: 'Fritschi C, Quinn L. Fatigue in patients with diabetes: a review. J Psychosom Res. 2010;69(1):33–41.', url: 'https://doi.org/10.1016/j.jpsychores.2010.01.021' },
  { n: 21, text: 'Bernhardt V, Babb TG. Exertional dyspnoea in obesity. Eur Respir Rev. 2016;25(142):487–495.', url: 'https://doi.org/10.1183/16000617.0081-2016' },
];
