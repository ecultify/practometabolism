...
export const references: { n: number; text: string; url: string }[] = [
  ...
  { n: 12, text: 'Zurbau A, Noronha JC, Khan TA, Sievenpiper JL, Wolever TMS. The effect of oat β-glucan on postprandial blood glucose and insulin responses: a systematic review and meta-analysis. Eur J Clin Nutr. 2021;75(11):1540–1554.', url: 'https://doi.org/10.1038/s41430-021-00875-9' },
  ...
  { n: 16, text: 'National Institute for Health and Care Excellence. Overweight and obesity management: identifying and assessing overweight, obesity and central adiposity. NICE guideline NG246. 2025.', url: 'https://www.nice.org.uk/guidance/ng246/chapter/Identifying-and-assessing-overweight-obesity-and-central-adiposity' },
  { n: 17, text: 'Jayedi A, Soltani S, Zargar MS, Khan TA, Shab-Bidar S. Adult weight gain and the risk of cardiovascular disease: a systematic review and dose-response meta-analysis of prospective cohort studies. Eur J Clin Nutr. 2020;74(9):1263–1275.', url: 'https://doi.org/10.1038/s41430-020-0610-y' },
  { n: 18, text: 'Burian EA, Franks PJ, Borman P, et al. The impact of obesity on chronic oedema/lymphoedema of the leg: an international multicenter cross-sectional study (LIMPRINT). Int J Obes (Lond). 2024;48(9):1238–1247.', url: 'https://doi.org/10.1038/s41366-024-01544-0' },
